...
class SelectedContentCustomer extends StatefulWidget {
  @override
  State<SelectedContentCustomer> createState() =>
      _SelectedContentCustomerState();
}

class _SelectedContentCustomerState extends State<SelectedContentCustomer> {
